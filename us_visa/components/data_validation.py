...
from evidently.data_drift import DataDriftProfileSection
...
from us_visa.entity.config_entity import validationConfig
from us_visa.constants import SCHEMA_FILE_PATH

class DataValidation:
    def __init__(self, data_ingestion_artifact: DataIngestionArtifact, data_validation_config: validationConfig):
        """
    ...
    def validate_number_of_columns(self, dataframe: DataFrame) -> bool:
        ...
        try:
            status = len(dataframe.columns) == self._schema_config["columns"]
    ...
    def detect_dataset_drift(self, refrence_df: DataFrame, current_df: DataFrame) -> bool:
        """
    ...
    def initiate_data_validation(self) -> DataValidationArtifact:
        ...
        try:
            ...
            train_df, test_df = (DataValidation.read_data(file_path=self.data_ingestion_artifact.training_file_path), DataValidation.read_data(file_path=self.data_ingestion_artifact.testing_file_path))
